# Topic Deep-Dive: Wellbeing & Health
*Cross-faculty analysis from the full crawl. June 2026.*

**87 wellbeing-health–tagged pages** sit across the faculty estate — a mid-sized topic, but a deceptive one. More than half of it (MDHS, 44 pages) is **placement-clearance and fitness-to-practice machinery** — immunisations, police/WWCC/NDIS checks, AHPRA registration — which is "health" only in the regulatory sense and is genuinely faculty-owned. The genuinely *pastoral* wellbeing content is thin, and where it exists (FEIT, Science, FBE, MBS, Law) it is a near-identical "Wellbeing + Ambassadors" landing pattern that funnels students to the same central services — the clearest consolidation candidate in the topic.
...
| Education | 3 | Wellbeing-and-support landing + special consideration |
| Arts | 2 | Arts West disability access (duplicated URL) |
| Business & Economics (FBE) | 2 | "Wellbeing" + "Ambassadors" |
| Melbourne Business School (school · FBE) | 2 | "Wellbeing" + "Ambassadors" |
| Fine Arts & Music | 1 | Quiet spaces at Southbank |
| **Total** | **87** | |

MDHS alone holds **51%** of the topic — but it is not pastoral wellbeing content; it is the clinical-placement compliance estate. Strip that out and the genuine student-wellbeing footprint across the other ten units is roughly two dozen pages, most of it duplicated landing material.

## Types of Wellbeing & Health content

1. **Placement immunisation & infection-control records** — the largest single block, all MDHS: "Hepatitis B", "Measles, Mumps and Rubella (MMR)", "Tuberculosis", "Varicella", "Pertussis", "Influenza", "COVID-19", "Hand Hygiene", "Mask Fit Testing". These are health *requirements* tied to clinical placement, with per-disease evidence rules. Faculty-owned by necessity. *MDHS only.*
2. **Pre-placement screening & background checks** — adjacent to the above and equally MDHS-bound: "Working with Children Check", "Australian Police Check", "Overseas Police Record", "NDIS Worker Screening Check", "CPR and First Aid", "Summary of checks", "Non-Immunisation Checks". Regulatory gatekeeping, not wellbeing support. *MDHS only.*
3. **Fitness-to-practice / professional-conduct health** — a discrete MDHS sub-estate: "Student Fitness to Practice", "Examples of Concerns", "MDHS Student Fitness to Practice Process", "Frequently Asked Questions", "Links and Resources". Governed by University policy (MPF1345) but operationalised at faculty level for placement-bearing courses. *MDHS only.*
4. **Pastoral wellbeing landing pages** — the genuine "student wellbeing" content, and the most duplicated type. Near-identical thin pages: FEIT "Health and Wellbeing Resources", Science "Student wellbeing", FBE "Wellbeing", MBS "Wellbeing", Law "Wellbeing", Education "Wellbeing and Support". Each restates the same central services (counselling, Safer Community, crisis lines). *FEIT, Science, FBE, MBS, Law, Education.*
5. **Wellbeing ambassador / peer programs** — a recurring twin of the landing page: FBE "Ambassadors", MBS "Ambassadors", FEIT "Wellbeing Series" and its "Student Clubs and Societies", Science "SWOT Vac Wellbeing Brunch". Peer-led activity that is legitimately local. *FBE, MBS, FEIT, Science.*
6. **Special consideration & extensions (health-driven)** — the academic-relief side of wellbeing, all anchored to central policy MPF1326: Law "Special consideration", "Extensions", "Registration for ongoing support"; Education "Special Consideration". Faculty pages restate a centrally-owned process. *Law, Education.*
7. **Disability, equity & access support** — Law "Student Equity and Disability Support"; Arts "Arts West building disability access" (appearing twice under different URLs). A central service (Student Equity and Disability Support / SEDS) restated or localised to a building. *Law, Arts.*
...
| Fitness-to-practice process for placement courses (MDHS) | Disability/equity support restating central SEDS (Law) |
...
- **237w** — [Links and Resources](https://mdhs.unimelb.edu.au/study/current-students/student-fitness-to-practice/links-and-resources)
...
- **706w** — [Q fever vaccinations](https://science.unimelb.edu.au/students/q-fever-vaccinations)
...
### FBE — 2
- **850w** — [Wellbeing](https://fbe.unimelb.edu.au/students/wellbeing)
- **419w** — [Ambassadors](https://fbe.unimelb.edu.au/students/wellbeing/ambassadors)

### MBS (school) — 2
- **821w** — [Wellbeing](https://mbs.unimelb.edu.au/students/wellbeing)
