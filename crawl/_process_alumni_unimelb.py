#!/usr/bin/env python3
"""Post-process the alumni.unimelb raw crawl into pages/alumni-unimelb.json + summary."""
import json
import re
...
RAW = f"{BASE}/raw/_alumni_unimelb_raw_crawl.json"
OUT_JSON = f"{BASE}/pages/alumni-unimelb.json"
OUT_MD = f"{BASE}/pages/alumni-unimelb-summary.md"
OUT_DISC = f"{BASE}/pages/alumni-unimelb-discovered.txt"

UNIT = "alumni-unimelb"
PARENT = "alumni"
HOST = "alumni.unimelb.edu.au"
PRE = "/"
...
TAG_RULES = [
    # Existing tags retained for cross-site comparison
    ("careers-employability", r"career|employab|employment|job|professional development|mentor"),
    ("student-life", r"student life|community|peer|society|network"),
    ("clubs-events", r"\bclub|event|reunion|workshop|seminar|lecture"),
    ("wellbeing-health", r"wellbeing|wellness|health|counsel|mental health|support"),
    ("research-candidature", r"candidatur|PhD|doctora|thesis|research|academic"),
    ("scholarships", r"scholarship|bursary|stipend|grant\b|prize"),
    ("international", r"international|global|overseas|abroad"),
    ("graduation", r"graduat|ceremony|testamur|conferral|completion"),
    ("contacts-support", r"contact|enquir|help|get in touch"),
    ("forms-admin", r"\bform\b|application|administration|request"),
    # Alumni-specific extended tags
    ("alumni-community", r"alumni|alumnus|alumna|graduate community|former student|old collegian"),
    ("alumni-events", r"alumni event|reunion|homecoming|lecture series|panel|networking event|alumni day"),
    ("alumni-careers-mentoring", r"mentor|career program|industry connection|professional network|alumni career"),
    ("alumni-giving", r"donat|giving|philanthrop|endow|bequest|gift|support the university|fund"),
    ("alumni-benefits", r"alumni benefit|discount|privilege|membership|library access|email|graduate benefit"),
]
...
lines = []
lines.append("# alumni.unimelb.edu.au — crawl summary\n")
lines.append(f"- **Unit:** {UNIT}")
lines.append(f"- **Type:** Alumni engagement and community site")
...
overlap_tags = {"careers-employability", "student-life", "clubs-events", "scholarships", "research-candidature", "graduation"}
...
disc_lines = [
    "# alumni.unimelb.edu.au — discovered subpaths",
