...
|---|--:|---|
| FEIT | 34 | Discipline clubs + a full club-admin toolkit + an events calendar |
| Law | 15 | Student societies, mooting, and graduate-researcher community profiles |
| Architecture, Building & Planning (MSD) | 15 | Design clubs + the MSDx student exhibition apparatus |
...
FEIT alone holds **a third** of the topic — not because it has more clubs than other faculties, but because it has documented the *administration* of clubs (committee guidance, funding, room booking, newsletter promotion) far more thoroughly than anyone else, and bolted on a multi-page events calendar.

## Types of Clubs & Events content

1. **Discipline-specific club & society directories** — the spine of the topic, and irreducibly faculty-owned. Each faculty lists the clubs tied to its disciplines: *FEIT* "Our Clubs" (Mechanical Engineering Student Society, Drone Aviation and Racing Engineering Society, Melbourne University Civil and Structural Society, Geomatics Society); *ABP/MSD* "Clubs and Societies" (Construction Students Association); *MDHS*, *Science* and *Biomedical* "Student Clubs and Societies". These name real, named student bodies a central directory could never enumerate.

2. **Performance ensembles & participation groups** — Fine Arts & Music's entire share, and a genuinely distinct content type: not "clubs" in the social sense but credit-adjacent participation requiring audition and registration. *FFAM* "Big Band", "Symphonic Ensembles application and registration", "Chamber Music", "Percussion Ensemble". Eligibility, audition and registration mechanics make these closer to subject content than to social clubs.
...
6. **Mentoring & ambassador programs** — student-community programs that aren't clubs but recruit students into the life of the faculty. *Education* "Peer Mentoring", "Career Mentoring", "Student Ambassador program"; *Arts* "Arts Student Ambassadors" (which appears twice, under both the undergraduate and graduate-coursework trees). Recruitment copy ("expand your network, strengthen your resume") tuned to each cohort.
