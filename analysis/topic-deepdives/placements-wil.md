...
|---|--:|---|
| Medicine, Dentistry & Health Sciences | 96 | Clinical-placement compliance spine: pre-placement checks, per-department before/during/conclude guides |
| Law | 36 | MLS Clinics, legal internships, global/partner programs, admission to practice |
| Education | 24 | ITE professional-experience machinery: allocation, structure, conduct, hurdles |
| Engineering & IT (FEIT) | 17 | Internship subjects (self-sourced / university-sourced / international) + Practice Hurdle |
| Arts | 13 | Experiential-learning internship subjects (Journalism, EMA, SCC, Social Impact) |
| Architecture, Building & Planning (MSD) | 9 | ABPL90434 construction-management internship + vocational placements |
| Fine Arts & Music | 5 | Ignite LAB industry incubator + research-student opportunities |
| Biomedical Sciences (school · MDHS) | 4 | Redirects to study.unimelb major pages (no real WIL content) |
| Science | 2 | Internship subjects + industry projects |
| **Total** | **206** | |

MDHS alone holds **47%** of the topic — and almost all of it is the clinical-placement *compliance* apparatus (immunisation, police/WWCC/NDIS checks, the Sonia tracking system, fitness-to-practice), which no other faculty needs at this depth. Placements are the most faculty-concentrated topic in the entire estate.

## Types of Placements & Work-Integrated Learning content

1. **Pre-placement compliance & clearance** — the immunisation/screening gate students must clear before any clinical placement. *MDHS* dominates: "MDHS Pre-Placement Requirements", "Summary of checks", "Working with Children Check", "NDIS Worker Screening Check", "Australian/Overseas Police Check", and a full infection series ("Hepatitis B", "Tuberculosis", "MMR", "Varicella", "Pertussis", "Influenza", "COVID-19", "Mask Fit Testing"). *Education* carries a thin equivalent ("Working with Children Check"). This is the largest single cluster and is wholly accreditation-driven.

2. **Placement lifecycle guides (before / during / conclusion / day one)** — a templated per-department walkthrough of the placement itself. *MDHS* repeats this structure across every clinical school: "Before placement / During placement / Conclusion of placement / Day one" for Melbourne Dental School, Department of Nursing, Clinical Audiology, Speech Pathology, MSPGH, and the psychology streams (clinical / professional / neuropsychology). The repetition is structural, not redundant — each department's content differs.

3. **Credit-bearing internship & WIL subjects** — named, assessed subjects where the placement *is* the curriculum. *FEIT* "Self-sourced / University-sourced / International internships", "Internship subjects", "Not-for-Credit Internships"; *Arts* "Journalism Internship", "EMA Internship Subject", "SCC Graduate Internship Subjects", "Internship: Personal & Career Growth"; *ABP* "ABPL90434 Construction Management Internship" (+ "Self-sourced" / "How to apply" / "Information for hosts"); *Science* "Internships in the Faculty of Science", "Industry projects for graduate students".

4. **Clinical & legal clinics (live-client practice)** — supervised real-client work delivered as subjects. *Law* is the centre of gravity: "Melbourne Law School Clinics", "Legal Internship", "Public Interest Law Clinic", "Sustainability Business Clinic", "Tax Clinic", "Stateless Legal Clinic", "Street Law", "NDIS and Disability Benefits Clinic", "Indigenous Legal Advocacy Clinic", "Disability Human Rights Clinic", "Law Apps".
...
8. **Placement logistics, rights & support** — the practical and pastoral wrapper around a placement. *MDHS* "Travel", "Insurance", "Visas", "Obligations, Rights & Responsibilities", "Personal information & Intellectual Property", "Getting help", "Sonia" (the placement-tracking system), "Key Contacts", "Student Testimonials"; *Education* "Roles and responsibilities", "Attendance and absences".

9. **Fitness / conduct to practise** — the professional-standards regime that governs students on placement. *MDHS* "Student Fitness to Practice", "MDHS Fitness to Practice Process", "Examples of Concerns"; *Education* "Professional Conduct"; *Law* "Admission to Practice". Tied directly to registration and the right to be in a clinical/professional setting.
