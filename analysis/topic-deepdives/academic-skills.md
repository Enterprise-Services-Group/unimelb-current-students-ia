...
|---|--:|---|
| Law | 11 | Ian Malkin Centre for Legal Academic Skills + legal research/writing |
| ABP/MSD | 5 | Studio archive + student-experience pages (loosely tagged) |
| Engineering & IT (FEIT) | 4 | Generic "Academic Skills" + study resources + thesis writing |
| Education | 4 | Academic Skills module + peer mentoring |
| Arts | 3 | Peer mentoring / PASS / academic mentoring |
| Science | 3 | "Build your academic skills" + academic English tutorials |
| Business & Economics (FBE) | 2 | Academic Success + quantitative requirement |
| Fine Arts & Music (FFAM) | 2 | Research-student ethics/integrity + student services |
| Biomedical Sciences (school · MDHS) | 2 | Two parallel "Academic Skills" pages (UG + master's) |
| Medicine, Dentistry & Health Sciences | 1 | Placement-bound skills page |
| **Total** | **37** | |

Law holds **30%** of the topic single-handed — but unlike the program-driven volume elsewhere in the audit, that bulk is a self-contained legal-skills centre (the Ian Malkin Centre) rather than per-degree pages. Most other faculties carry only 2–4 pages, several of them generic restatements of the same idea.

## Types of Academic Skills content

1. **Discipline-specific academic-skills centres / programs** — the legitimate, irreducible core. *Law*'s "Ian Malkin Centre for Legal Academic Skills" with "Early Academic Guidance for Legal Education", the "Legal Academic Skills LMS Community", "Writing for law" and "About the Centre and facilities"; this is a named teaching service with its own staff and LMS, not generic advice.
2. **Discipline-specific writing & research skills** — skills taught *through* the discipline. *Law* "Legal Research" (5,424w — by far the deepest page in the topic) and "Student Achievement and Grading"; *FEIT* "Thesis writing events"; *FFAM* "Research Ethics & Integrity". These can't be centralised because the worked examples are the discipline.
3. **Academic English / language support tutorials** — for cohorts with EAL needs, tuned to the discipline's register. *Science* "Science Academic English Tutorials"; *FEIT*'s orientation-stream "Academic Skills" page (filed under "improve your English, communication and academic skills").
...
| Discipline academic-English tutorials (Science, FEIT) | Peer-mentoring / PASS descriptions (Arts, Education) — same model, repeated |
...
### Science — 3
- **631w** — [Science Academic English Tutorials](https://science.unimelb.edu.au/students/enrich-your-studies/academic-skills/graduate-science-academic-english-tutorial)
- **612w** — [Build your academic skills](https://science.unimelb.edu.au/students/enrich-your-studies/academic-skills)
- **515w** — [Enrich your studies](https://science.unimelb.edu.au/students/enrich-your-studies)
