# Topic Deep-Dive: Course Planning
...
|---|--:|---|
| Melbourne Business School (school · FBE) | 58 | One sample course plan per master's program + variants |
| Biomedical Sciences (school · MDHS) | 37 | First-year subject planning, majors, breadth, honours |
| Architecture, Building & Planning (MSD) | 29 | Per-degree + double-masters sample course plans |
| Science | 26 | Per-major "getting started" guides + course guides |
| Education | 20 | Placement-bound program planning (ITE) |
| Law | 11 | JD/MLM course structure, advising, acceleration |
| Business & Economics (FBE) | 8 | Honours planning |
| Arts | 6 | Course-structure overview, Diploma in Languages |
| Fine Arts & Music | 6 | Subject enrolment, music performance planning |
| Medicine, Dentistry & Health Sciences | 4 | Registration-bound (AHPRA, psychology streams) |
| Engineering & IT (FEIT) | 2 | Re-hosts My Course Planner + resources |
| **Total** | **207** | |

Two schools (MBS, Biomedical) alone account for **46%** of all course-planning content — a direct consequence of the school-level fragmentation seen elsewhere in the audit.

## The nine types of course-planning content

1. **Degree-specific sample course plans / course maps** — subject-by-semester plans for a named program. The largest category by far. *MBS* (one per master's program — Management, Finance, International Business, 150/200-point, research pathways); *ABP/MSD* (per-degree and double-masters combinations — Architecture/Construction, Landscape/Urban Planning, etc.).
2. **"Getting started" subject-selection guides by major/discipline** — which subjects, in what order, for a major. *Science* ("Mathematics & Statistics / Physical Sciences / Geography / Earth Sciences / Chemical Sciences / Psychological Sciences… starting in the Bachelor of Science"); *Biomedical* ("Plan your First Year Subjects", "Majors").
...
*Complete list of the 207 course-planning–tagged pages (deduplicated by URL). Full data: `data/course-planning-pages.csv`.*

### Melbourne Business School (school · FBE) — 58 pages
...
- **1017w** — [Master of Management (Accounting) 150 point](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-management-accounting-plan-2)
...
- **943w** — [Master of Management (200 point)](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-management)
...
- **937w** — [Student Support](https://mbs.unimelb.edu.au/students/course-planning/student-support)
...
- **919w** — [Master of Management (150 point)](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-management-150-point)
...
- **889w** — [Master of Commerce (Actuarial Science)](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-commerce-actuarial-science)
...
- **886w** — [Changing Courses](https://mbs.unimelb.edu.au/students/course-planning/changing-courses)
...
- **862w** — [Master of Management (Human Resources) 200 point](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-management-human-resources)
- **861w** — [Master of Management (Supply Chain Management) 150pt](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-management-supply-chain-management-150pt)
- **860w** — [Master of Economics](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-economics)
...
- **852w** — [Master of Applied Econometrics](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-applied-econometrics-commenced-prior-to-2022)
- **848w** — [Master of Applied Econometrics (Enhanced)](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-applied-econometrics2)
...
- **839w** — [Master of Management (Marketing) 200 point](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-management-marketing)
- **837w** — [Master of Management (Supply Chain Management) 200pt](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-management-supply-chain-management-200pt)
...
- **833w** — [Master of Management (Human Resources) 150 point](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-management-human-resources-150-point)
...
- **817w** — [Course Plans](https://mbs.unimelb.edu.au/students/course-planning/course-plans)
- **805w** — [Master of Management (Marketing) 150 point](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-management-marketing-150)
...
- **779w** — [Master of Management (Accounting) 200 point](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-management-accounting)
- **774w** — [Master of Actuarial Science (Enhanced)](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-actuarial-science-enhanced)
- **745w** — [Master of Actuarial Science (Extended)](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-actuarial-science)
- **717w** — [Master of Entrepreneurship (Enhanced) - New Venture Creation Pathway](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-entrepreneurship-commenced-prior-to-2023)
- **707w** — [Master of Entrepreneurship (Enhanced) - Intrapreneurship Pathway](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-entrepreneurship-enhanced-new-venture-creation-pathway)
- **706w** — [Master of Actuarial Science](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-actuarial)
- **697w** — [Master of Digital Marketing](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-digital-marketing)
- **657w** — [Master of Indigenous Business Leadership](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs/master-of-indigenous-business-leadership)
- **641w** — [Open Access Student Computing Spaces](https://mbs.unimelb.edu.au/students/course-planning/services/computing-spaces)
- **562w** — [Masters Programs](https://mbs.unimelb.edu.au/students/course-planning/course-plans/masters-programs)
- **512w** — [Key Dates and Contacts](https://mbs.unimelb.edu.au/students/course-planning/student-administration)
- **463w** — [Rules and conditions](https://mbs.unimelb.edu.au/students/course-planning/services/rules)
...
- **386w** — [Students](https://mbs.unimelb.edu.au/students)
- **366w** — [Course Planning](https://mbs.unimelb.edu.au/students/course-planning)
- **299w** — [Services and Facilities](https://mbs.unimelb.edu.au/students/course-planning/services)
- **288w** — [Virtual Lab](https://mbs.unimelb.edu.au/students/course-planning/services/virtual-lab)

### Biomedical Sciences (school · MDHS) — 37 pages
...
### Architecture, Building & Planning (MSD) — 29 pages
...
- **725w** — [Master of Landscape Architecture/Master of Urban Design](https://msd.unimelb.edu.au/current-students/course-planning/sample-course-plans/double-masters/landscape-architecture-urban-design)
...
- **685w** — [Master of Construction Management Sample Course Plans](https://msd.unimelb.edu.au/current-students/course-planning/sample-course-plans/master-of-construction)
...
- **651w** — [Master of Architecture/Master of Urban and Cultural Heritage](https://msd.unimelb.edu.au/current-students/course-planning/sample-course-plans/double-masters/architecture-urban-cultural-heritage)
...
- **592w** — [Master of Property Sample Course Plans](https://msd.unimelb.edu.au/current-students/course-planning/sample-course-plans/master-of-property)
...
- **560w** — [Master of Architecture Sample Course Plans](https://msd.unimelb.edu.au/current-students/course-planning/sample-course-plans/master-of-architecture)
- **559w** — [Master of Landscape Architecture Course Plans](https://msd.unimelb.edu.au/current-students/course-planning/sample-course-plans/landscape-architecture-course-plans)
- **530w** — [Master of Urban Planning Sample Course Plans](https://msd.unimelb.edu.au/current-students/course-planning/sample-course-plans/urban-planning)
...
- **1304w** · _mixed_ — [Course guide: Bachelor of Science](https://science.unimelb.edu.au/students/course-guide-bachelor-of-science)
...
- **1182w** — [Course guide: Bachelor of Agriculture](https://science.unimelb.edu.au/students/course-guide-bachelor-of-agriculture)
...
- **973w** — [Course guide: Graduate coursework degrees](https://science.unimelb.edu.au/students/course-guide-graduate-coursework-degrees)
...
- **941w** — [Course guide: Diploma in General Studies](https://science.unimelb.edu.au/students/course-guide-diploma-in-general-studies)
...
- **852w** — [Dookie Semester](https://science.unimelb.edu.au/students/course-guide-bachelor-of-agriculture/dookie-semester)
...
- **439w** — [Bachelor of Science Majors Information Series](https://science.unimelb.edu.au/students/course-guide-bachelor-of-science/bachelor-of-science-majors-series)
...
- **500w** — [Time Commitment and Timetabling](https://law.unimelb.edu.au/students/jd/studies/time-commitment-and-timetabling)
...
### Business & Economics (FBE) — 8 pages
...
- **614w** — [Studies in Engineering](https://fbe.unimelb.edu.au/students/bcom/current-students/studies-in-engineering)
- **492w** — [What is Honours?](https://fbe.unimelb.edu.au/students/bcom/honours/what-is-honours)
- **448w** — [Course Planning](https://fbe.unimelb.edu.au/students/bcom/current-students)
- **352w** — [Academic Success](https://fbe.unimelb.edu.au/students/bcom/current-students/academic-success)
- **314w** — [Bachelor of Commerce (Honours)](https://fbe.unimelb.edu.au/students/bcom/honours)
- **301w** — [Honours Convenors](https://fbe.unimelb.edu.au/students/bcom/honours/convenors)
...
### Medicine, Dentistry & Health Sciences — 4 pages
