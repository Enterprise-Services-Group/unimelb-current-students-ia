...
|---|--:|---|
| Law | 15 | GRD student-profile bios (false positives) + 4 equity/disability clinics |
| ABP/MSD | 11 | Design-studio archive pages (all false positives) |
| MDHS | 8 | Placement NDIS/fitness-to-practice checks + 1 Indigenous success page |
| FEIT | 6 | One Diversity & Inclusion Case Competition (5 pages) + Indigenous experience |
| Arts | 6 | Arts West disability access (duplicated) + enrichment/employability |
| Science | 1 | Current Indigenous students |
| FFAM | 1 | Practical-music timetable (link-farm false positive) |
| MBS (school) | 1 | Master of Indigenous Business Leadership |
| **Total** | **49** | |

Law and ABP together hold **53%** of the tag, but almost none of it is real: Law's 15 are mostly graduate-researcher bios (Aashish Yadav, Ishika Chatterjee…), and all 11 ABP pages are studio archives. Strip the noise and only **~13 pages** are genuinely about inclusion or equity.
...
3. **Physical-access / building accessibility** — a genuinely faculty-owned slice because buildings are local. *Arts* "Arts West building disability access" ("Getting into Arts West… the pathway") — and it appears **twice** (two URLs, same content), the only true intra-faculty duplicate in the topic.

4. **Equity-themed clinical & experiential subjects** — discipline-specific curriculum, not a service. *Law* MLS clinics: "Disability Human Rights Clinic" + "DHRC Research Outcomes," "Indigenous Legal Advocacy Clinic," "Stateless Legal Clinic" ("Citizenship to me means protection and certainty for my children…"). Legitimately Law-only.

5. **Diversity & inclusion co-curricular programs** — *FEIT*'s "Diversity & Inclusion Case Competition" spread across 5 thin pages (landing / How Does It Work / Eligibility / Prizes), the classic one-event-fragmented-into-many-pages pattern.

6. **Compliance "equity" (mis-tagged)** — *MDHS* placement pages — "NDIS Worker Screening Check," "student-fitness-to-practice / Examples of Concerns," "Handbook," "Key Contacts" — tagged on "NDIS"/"disability" keywords but are really placement-compliance content belonging to the placements topic.
...
### Science — 1
- **1161w** — [Current Indigenous students](https://science.unimelb.edu.au/students/current-indigenous-students)
