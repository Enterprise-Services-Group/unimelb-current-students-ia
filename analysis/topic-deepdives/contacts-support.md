# Topic Deep-Dive: Contacts & Support
...
|---|--:|---|
| Arts | 50 | Mentoring/peer programs, GR support shells, AV/facilities, many duplicate `_nocache` URLs |
| Law | 36 | The "Academic Support & Wellbeing" tree, careers, mentor program, academic-skills centre |
| Medicine, Dentistry & Health Sciences | 35 | Placement-bound "getting help"/key-contacts, student enrichment, clubs |
| Architecture, Building & Planning (MSD) | 19 | IT support, studio/facilities, clubs & societies, newsletters |
| Engineering & IT (FEIT) | 14 | FAQ pages (internship, scholarship), IT contact, international support |
...
## Types of Contacts & Support content

1. **Faculty IT & tech support / facilities** — the most substantive, genuinely faculty-owned cluster, because it documents *physical* discipline kit. *ABP* "IT Support" (3,247w — Affinity Suite licensing, BDes/MSD lab software); *FFAM* "Tech Support and Facilities" (3,501w — equipment loans, storerooms, digital printing for VCA & MCM); *FEIT* "Student IT Contact"; *Arts* "Audio/Visual loan equipment", "Video edit suites". Studio-bound disciplines need this; a generic central IT page can't replace it.
2. **Wellbeing, equity & disability support** — *Law* runs a whole sub-tree: "Wellbeing", "Student Equity and Disability Support", "Extensions", "Special consideration", "Registration for ongoing support". Note the wording leads with University-wide emergency/Security numbers and Counselling and Psychological Services — i.e. it re-states central services with a faculty contact bolted on. *Education* "Wellbeing and Support"; *MDHS* "Getting help" (incidents, harassment, insurance, legal advice during placement).
