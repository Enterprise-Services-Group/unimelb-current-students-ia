# Topic Deep-Dive: International Student Support
...
|---|--:|---|
| Law | 55 | Degree partnerships + Study Overseas + GRD researcher profiles |
| Architecture, Building & Planning (MSD) | 28 | Travelling Studios archive + subjects with a travel component |
| Engineering & IT (FEIT) | 25 | Study-abroad/exchange, international research, mobility funding |
| Arts | 10 | Overseas experience + mobility funding (mostly URL duplicates) |
| Medicine, Dentistry & Health Sciences (MDHS) | 7 | Overseas-placement logistics (travel, visas, insurance, police checks) |
| Melbourne Business School (school · FBE) | 7 | Master of International Business dual degrees + research pathways |
| Fine Arts & Music | 2 | International ensemble/touring & support scheme |
| Biomedical Sciences (school · MDHS) | 1 | Study Abroad and Exchange |
| **Total** | **135** | |

Three units — Law, ABP and FEIT — hold **80%** of the topic, and all three are dominated by *mobility* content (sending Melbourne students out), not *international-student* content (supporting students who came in). No faculty owns a substantive inbound-support presence; that gap is structural, not accidental.

## Types of International Student Support content

1. **Outbound exchange & study-overseas programs** — the single largest theme: semester-for-credit study at partner institutions. *Law* "Study Overseas program", "Exchange Partners", "Non-partner programs"; *FEIT* "Study abroad and exchange", "Global Experience"; *Arts* "Overseas experience"; *Biomedical* "Study Abroad and Exchange". This is the canonical "global mobility" pattern, replicated per-faculty.

2. **Named degree partnerships & dual degrees** — bilateral arrangements with specific overseas universities, each its own page. *Law* runs the deepest set — "Degree Partnerships", "New York University JD-LLM", "University of Oxford BCL or MLF", "University of Cambridge LLM/MCL", "NUS Master of Laws", "Peking University", "Leiden University", "Shanghai Jiao Tong University". *FBE/MBS* "Master of International Business Dual Degrees" (Inbound/Outbound). Inherently discipline-specific and uncentralisable.

3. **International research placements & summer programs** — short-term overseas research for coursework/research students. *FEIT* dominates: "International Research Opportunities", "KAIST Visiting Student Researcher Program", "POSTECH", "Kyoto University KU-STAR", "University of Twente Summer Research Program", "Catholic University of Louvain Summer Research Program".

4. **Travelling studios & subjects with a travel component** — discipline-specific subjects delivered overseas, plus a deep year-by-year archive. *ABP/MSD* almost entirely: "Travelling Studios", "Southeast Asia Travelling Studio", "Subjects with a Travel Component", and a long "Past Studios" run (2008–2025). Legitimate but heavily archival.

5. **International internships & intercultural career programs** — work-integrated and career content with a global frame. *FEIT* "International internships" (the topic's largest single page, 4,609w), "Intercultural Career Mentoring Program", "Global Skills Series", "Global Skills Series"; *Law* "International Legal Internship", "British Institute of International and Comparative Law Internship", "ELLIS Program".
